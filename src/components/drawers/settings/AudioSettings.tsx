import { AudioLines, ChevronLeft, Trash2 } from "lucide-react";
...
export const AudioSettings = ({ onBack, onDelete, onNodeDataChange }: Props) => {
  ...
  return (
    <div className="flex h-full flex-col">
      <div className="relative flex items-center px-3 py-6">
        ...
        <div className="mx-auto flex items-center gap-2 text-audio">
          <AudioLines size={20} />
